        ...
        <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in duration-700">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-[32px] border border-slate-200 dark:border-slate-700 shadow-sm space-y-6">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            <div className="space-y-1">
                                <div className="text-sm font-mono font-bold text-indigo-600 tracking-tighter uppercase">{complaint.number}</div>
                                <h1 className="text-3xl font-bold text-slate-900 dark:text-white uppercase">{complaint.title}</h1>
                                <p className="text-slate-500 text-sm">Submitted on {complaint.date}</p>
                            </div>
                            <div className="px-6 py-2 bg-blue-100 text-blue-700 border border-blue-200 rounded-full text-sm font-bold capitalize">
                        ...
                        <div className="pt-6 border-t border-slate-100 dark:border-slate-700 flex flex-wrap gap-8">
                            <div className="space-y-1">
                                ...
                                <div className="flex items-center gap-2 text-slate-900 dark:text-white font-medium">
                                    <MapPin size={16} className="text-indigo-600" /> {complaint.address}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-50/50 to-blue-50/50 dark:from-indigo-900/20 dark:to-blue-900/20 p-8 rounded-[32px] border border-indigo-100 dark:border-indigo-800 shadow-xl shadow-indigo-100/20 dark:shadow-none space-y-6 relative overflow-hidden">
                        <div className="absolute top-0 right-0 p-8 text-indigo-100 dark:text-indigo-900/40 -z-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-8 relative z-10">
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="inline-block px-3 py-1 bg-red-100 text-red-700 border border-red-200 rounded-lg text-xs font-bold uppercase tracking-widest">{complaint.severity}</div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                <div>
                                ...
                                <div className="flex gap-4">
                                  <div>
                                     ...
                                     <div className="font-bold text-indigo-600">{complaint.helpline}</div>
                                  </div>
                                  <div>
                                     <div className="text-xs text-slate-500 font-bold uppercase tracking-wider mb-1">Official Email</div>
                                     <div className="font-bold text-indigo-600 underline">{complaint.email}</div>
                                  </div>
                                </div>
                            </div>
                        </div>

                        <div className="p-4 bg-white/60 dark:bg-slate-900/40 rounded-2xl border border-white/80 dark:border-slate-800 text-sm text-slate-600 dark:text-slate-400 italic">
                            " {complaint.reasoning} "
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                            ...
                            {complaint.timeline.filter(t => t.show).map((t, i) => (
                                <div key={i} className="relative pl-10 space-y-1">
                                    <div className={cn(
                                        ...
                                        i === 0 ? "border-indigo-600 text-indigo-600" : "border-slate-200 text-slate-300"
                                    )}>
                    ...
                    <div className="bg-white dark:bg-slate-800 p-8 rounded-[32px] border border-slate-200 dark:border-slate-700 shadow-sm space-y-4 text-center">
                        <div className="aspect-square bg-slate-100 dark:bg-slate-900 rounded-2xl flex items-center justify-center text-slate-400">
                             Media Item Proof
                        </div>
