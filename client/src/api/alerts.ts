 ...
 */
export const fetchAlerts = async (stateId?: string, cityId?: string): Promise<Alert[]> => {
...
export const createAlert = async (alertData: Partial<Alert>): Promise<{ success: boolean; alert?: Alert; error?: string }> => {
